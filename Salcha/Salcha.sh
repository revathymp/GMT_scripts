...
gmt begin Salcha pdf 

	# GMT set/configuration
	gmt set MAP_FRAME_TYPE plain

	# Generate base map
	gmt basemap -JM8c -R-148.2/-145.430/63.90431/64.957 -Xc -Yc -B0.05 -BweEN --FONT_ANNOT_PRIMARY=12p,Helvetica --MAP_DEGREE_SYMBOL=degree

	# Plot grid image
	gmt grd2cpt -R-148.2/-145.430/63.90431/64.957 Salcha.grd -Cgray -Z
	gmt grdimage -R-148.2/-145.430/63.90431/64.957 Salcha.grd -I+a15+ne0.75 
